public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Квадрат s3 " + s3.getX() + " " + s3.getY() + " " + s3.getColor() + " " + s3.getSideA());
        ...
        System.out.println("Эллипс e1 " + e1.getX() + " " + e1.getY() + " " + e1.getColor() + " " + e1.getSideA() + " " + e1.getSideB());
        System.out.println("Эллипс e2 " + e2.getX() + " " + e2.getY() + " " + e2.getColor() + " " + e2.getSideA());
